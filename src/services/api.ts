...
const MOCK_CATEGORIES = [
  { id: 1, name: 'Skincare', slug: 'skincare', image: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=800&q=80', description: 'Nourishing cleansers, radiant serums, and botanical moisturizers.' },
  { id: 2, name: 'Makeup', slug: 'makeup', image: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=800&q=80', description: 'Ultra-pigmented lips, velvet foundations, and luminous cheek balms.' },
  { id: 3, name: 'Haircare', slug: 'haircare', image: 'https://images.unsplash.com/photo-1527799820374-dcf8d9d4a388?w=800&q=80', description: 'Silk infusion hair oils, restorative masks, and scalp elixir treatments.' },
  { id: 4, name: 'Body Care', slug: 'body-care', image: 'https://images.unsplash.com/photo-1608248597369-1833589b33a7?w=800&q=80', description: 'Velvet soufflé lotions, exfoliating sea salt scrubs, and hydrating shower oils.' },
  { id: 5, name: 'Fragrance', slug: 'fragrance', image: 'https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?w=800&q=80', description: 'Artisanal Eau de Parfums and delicate hair & body mists.' },
  { id: 6, name: 'Beauty Tools', slug: 'beauty-tools', image: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=800&q=80', description: 'Rose quartz gua sha sculptors and sonic facial cleansers.' },
  { id: 7, name: 'Wellness', slug: 'wellness', image: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=800&q=80', description: 'Botanical beauty elixirs and stress-relief bath salts.' },
  { id: 8, name: 'Lifestyle', slug: 'lifestyle', image: 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=800&q=80', description: 'Scented soy candles, linen diffusers, and luxury eye sleep masks.' }
];
